...
if sidebar == 'Information':
    ...
    st.markdown("<h4 style='text-align: center;'>See below for resources on influencing these and other factors that may influence potential loan default.</h4>", unsafe_allow_html=True)
    
    st.markdown("<h3 style='text-align: left;'>Borrowers</h3>", unsafe_allow_html=True)
    st.markdown("<h5 style='text-align: left;'><a href='https://www.nerdwallet.com/article/loans/personal-loans/personal-loan-application-tips-win-approval'>Tips to improve chance to be approved for a loan.</a></h5>", unsafe_allow_html=True)    
    st.markdown("<h5 style='text-align: left;'><a href='https://www.indeed.com/career-advice/starting-new-job/how-increase-income'>Tips to increase your income.</a></h5>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align: left;'><a href='https://www.cibil.com/loan-approval-process'>Loan application process in India.</a></h5>", unsafe_allow_html=True) 
    st.markdown("<h3 style='text-align: left;'>Lenders</h3>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align: left;'><a href='https://repository.usfca.edu/cgi/viewcontent.cgi?article=1074&context=thes'>The effect of risk on loan default.</a></h5>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align: left;'><a href='https://www.bis.org/publ/work467.pdf'>Managing default risk.</a></h5>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align: left;'><a href='https://www.ecb.europa.eu/pub/pdf/scpwps/ecb.wp2514~43564dfc3d.en.pdf'>Risk aversion and bank loan pricing.</a></h5>", unsafe_allow_html=True)     
    st.markdown("<h3 style='text-align: left;'>Government Entities</h3>", unsafe_allow_html=True) 
    st.markdown("<h5 style='text-align: left;'><a href='https://statisticstimes.com/economy/india/indian-states-gdp.php'>GDP of Indian States, Interactive.</a></h5>", unsafe_allow_html=True)
    st.markdown("<h5 style='text-align: left;'><a href='https://www.jstor.org/stable/2328022'>The effect of government regulations on personal loan markets.</a></h5>", unsafe_allow_html=True)
    st.markdown("<h5 style='text-align: left;'><a href='https://www.oecd-ilibrary.org/sites/79321fa3-en/index.html?itemId=/content/component/79321fa3-en'>Government role in the redistribution of income and wealth.</a></h5>", unsafe_allow_html=True)
...
if sidebar == 'Updates':
    ...
    st.markdown("<h3 style='text-align: left;'>Potential updates: </h3>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: left;'>Models generalizable for areas outside of India.</h4>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: left;'>Increased input options for refined predictions.</h4>", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: left;'>Adjustable risk-aversion metrics for users.</h4>", unsafe_allow_html=True)    