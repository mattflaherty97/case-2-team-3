...
if sidebar == 'Updates':
    ...
    st.markdown("<h6 style='text-align: left;'>Models generalizable for areas outside of India.</h4>", unsafe_allow_html=True)
    st.markdown("<h6 style='text-align: left;'>Increased input options for refined predictions.</h4>", unsafe_allow_html=True)
    st.markdown("<h6 style='text-align: left;'>Adjustable risk-aversion metrics for users.</h4>", unsafe_allow_html=True)    